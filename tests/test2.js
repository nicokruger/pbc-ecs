...
describe('entity manager 2', function() {
    ...
    it('should be possible to get a list of entities that are in a system', function () {
      function TestComponent() {
        this.bla = 5;
      }
      TestComponent.__name = 'test';
      ...
      const testComponents = manager.querySystem(TestComponent);
      const test2Components = manager.querySystem(TestComponent2);

      assert.equal(testComponents.length, 2);
      assert.equal(test2Components.length, 1);
